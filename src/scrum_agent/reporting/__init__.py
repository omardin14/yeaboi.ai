...
def __getattr__(name: str):
    ...
    ``import scrum_agent.reporting`` (done by sessions.py's v9 migration for the
    ...
    if name == "gather_delivered_work":
        from scrum_agent.reporting.activity import gather_delivered_work
    ...
    if name in ("export_report", "build_presentation_html"):
        from scrum_agent.reporting import export, presentation
